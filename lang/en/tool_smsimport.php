...
$string['logmapping'] = 'Incorrect mapping';
$string['logmappinghelp'] = 'Incorrect data mapping for profile field';
$string['lognsndouble'] = 'Duplicate NSN';
$string['lognsndoublehelp'] = 'Duplicate NSN record found';
$string['lognodataprofilefield'] = 'Missing profile field';
$string['lognodataprofilefieldhelp'] = 'The API endpoint is not sending some profile data';
...
$string['smsconfigdesc'] = 'Add SMS configuration in CSV format. Add one per each line. For e.g. example_key, example_secret, example_name, https://myexample.com/gettoken, https://myexample.com/getStudentsData, https://myexample.com/getGroupsData<br><br> Please note that the example_name is considered a unique field and it will be replaced with new values,  if entered twice.';
$string['smsconfigadd'] = 'SMS configuration';
$string['smscurrentlyconfig'] = 'SMS currently configured: ';
$string['smsteacherrole'] = 'Teacher role';
...
$string['disableschooltransfer'] = 'Disable school transfer';
$string['disableschooltransfer_help'] = 'If selected then the ability to transfer a student from one school to another will be disabled.';
